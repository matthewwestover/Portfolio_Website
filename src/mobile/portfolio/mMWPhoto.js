...
<ThemeConsumer>
  {value => (
    <ContentDiv value={value}>
      <ContentHeader value={value} style={{fontWeight: 'bold'}} underlined>Matt Westover Photography</ContentHeader>
      <ContentText value={value} fSize='small' style={{marginTop: '20px'}}>This site is currently in development</ContentText>
      {/* <ProjectTech>
        <a
